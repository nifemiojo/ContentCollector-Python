...
function createData(name, description, socialLink) {
  return { name, description, socialLink };
}
...
const headCells = [
  ...
  { id: 'socialLink', numeric: true, disablePadding: false, label: 'Social Link' },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.socialLink}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
